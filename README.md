# List-at-least-10-methods-in-the-following-objects-describing-their-usage-and-differences-if-any-List at least 10 methods in the following objects, describing their usage, and differences (if any)
Number:
intValue():
